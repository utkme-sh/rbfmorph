...
# Package meta-data.
NAME = rbfmorph.__title__
DESCRIPTION = 'Python Geometrical Morphing.'
URL = 'https://github.com/mathLab/rbfmorph'
MAIL = rbfmorph.__mail__
AUTHOR = rbfmorph.__author__
VERSION = rbfmorph.__version__
...
LDESCRIPTION = (
    "rbfmorph is a python package using Free Form Deformation, Radial Basis "
